...
void check_error(SymbolTableEntry entry, SymbolTableEntry *entry_ptr)
{
    //todo BOTH functions
    if(isFunction(*entry_ptr) && isFunction(entry))
    {
        cout << "\033[1;31m" << 
                "Function redefinition at line "<< entry.value.funVal->line <<
                "\033[0m" << endl;
    }
    ...
    {
        cout << "\033[1;31m" << 
                "Variable redefinition as function at line "<< entry.value.funVal->line <<
                "\033[0m" << endl;
    }
