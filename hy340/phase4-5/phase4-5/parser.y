...
term:       START_PARENTHESIS expr END_PARENTHESIS  
            ...
            lvalue
            {
                ...
                if ($lvalue->type == tableitem_e) {
                    ...
                    emit(tablesetelem, $lvalue->index, $term, $lvalue, 0, yylineno);
                }
                else {
            ...
            PLUSPLUS    
            {
                ...
                if ($lvalue->type == tableitem_e) {
                    ...
                    emit(tablesetelem, $lvalue->index, val, $lvalue, 0, yylineno);
                }
                else {
                    emit(assign, $lvalue, nullptr, $term, 0, yylineno);
...
primary:    lvalue  {
                        ...
                        $primary = emit_iftableitem($lvalue, SCOPE, yylineno, FUNC_DEPTH);
                    }
            |call   
            {
            ...
            |START_PARENTHESIS funcdef END_PARENTHESIS  
            {
                ...
                $primary->sym = $funcdef;
                $primary->sym->space = currscopespace(); 
            }
            ...
            ASSIGN expr
            {
                ...
                if($lvalue->type != tableitem_e)
                {
                    if(!$expr->truelist.empty()) {
                        ...
                        $assignexpr->sym->space=currscopespace();
                ...
                else
                {
                    ...
                    emit(tablesetelem, $lvalue->index, $expr, $lvalue, 0, yylineno);
...
member:     lvalue DOT {lwarning = false;} ID
            ...
            |lvalue START_BRACKET{isindex = 1;} expr END_BRACKET
                                            { 
...
normcall:   START_PARENTHESIS {isLib=true;}elist END_PARENTHESIS 
            { 
...
objectdef:  START_BRACKET{isindex = 1;} elist END_BRACKET     
                                                {
...
const:              REAL        { 
                    ...
                    |INTEGER    { 
                                    ...
                                    number_table.push_back($INTEGER);
                                }
                    |STRING     {
...
ifprefix:           IF START_PARENTHESIS expr END_PARENTHESIS
                    {
                        ...
                        emit(if_eq, $expr, e, nullptr, nextquadlabel() + 2, yylineno);
...
forprefix:          FOR {loop_counter++;break_continues_belong.push_back("for");}START_PARENTHESIS elist SEMICOLON M expr SEMICOLON
                    {
                        ...
                        emit(if_eq, $expr, e, nullptr, 0, yylineno);
                        vector<int> v;
                        continue_quads.push_back(v);
                        break_quads.push_back(v);
                    }
